...
app.UseSwaggerUI(options =>
{
    ...
    foreach (var description in apiViewsionDescriptionProvider.ApiViewsionDescriptions)
    {
        options.SwaggerEndpoint(
            ...
            name: $"RETAIL_BASE API {description.GroupName.ToLowerInvariant()}" // Display name in the dropdown
        );
    }
...
app.MapControllers(); // Aseg�rate de que esta l�nea est� presente para manejar las paths de los controladores.
